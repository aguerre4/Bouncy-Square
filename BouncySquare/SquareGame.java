...
/**
 * Class SquareGame - write a description of the class here
 * 
 * @author (your name) 
 * @version (a version number)
 */
public class SquareGame extends Applet implements ActionListener,KeyListener,MouseListener
{
    ...
    public void init()
    {
        ...
        TitleBackground=getImage(getDocumentBase(),"Title.jpg");
    ...
    public void paint(Graphics g)
    {
        ...
        if(level==0){
            g.drawImage(TitleBackground,0,0,499,499,this);
